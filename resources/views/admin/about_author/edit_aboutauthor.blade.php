...
<div class="form-group">
    ...
    <input type="text" id="title" name="title" class="form-control" required value="{{ $about_author->title }}">
</div>


    <div class="form-group">
        <label for="description">Description</label>
        <textarea id="description" name="description" class="form-control" required>{{ $about_author->description }}</textarea>
    </div>

    <div class="div_design">
        <label>Current About Author Images:</label>
    ...
    <button type="submit" class="btn btn-primary">Update About Author</button>
